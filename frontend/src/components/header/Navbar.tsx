...
const Navbar = () => {
  return (
    <div className="sticky top-0 z-50">
      ...
      <div className="w-full max-w-screen bg-accent/20 backdrop-blur z-50 ">
        <MaxWidthWrapper>
          <nav>
            <div className="flex items-center justify-between w-full h-20 max-w-7xl mx-auto gap-5 ">
              ...
              <ul className="flex items-center h-full w-fit text-base font-semibold max-md:hidden">
                <li className="h-full w-fit">
                  <Link
                    href={""}
                    className="h-full w-fit px-2 flex items-center active"
                  >
                    Who we are
                  </Link>
                </li>
                ...
                <li className="h-full w-fit">
                  <Link
                    href={""}
                    className="h-full w-fit px-2 flex items-center"
                  >
                    Networks
                  </Link>
                </li>
